...
class Order(models.Model):
    ...
    img_url = models.URLField(blank=True,default='default.png',help_text=_("Image Url"))
    category = models.CharField(max_length=300,help_text=_("Category"))
    color = models.CharField(max_length=300,help_text=_("Color"))
    size = models.CharField(max_length=300,help_text=_("size"))
